...
download() {
    case $1 in
    core)
        link=https://ghproxy.net/https://github.com/v2fly/v2ray-core/releases/download/v5.31.0/v2ray-linux-64.zip
        [[ $is_core_ver ]] && link="https://ghproxy.net/https://github.com/v2fly/v2ray-core/releases/download/v5.31.0/v2ray-linux-64.zip"
        name=$is_core_name
        tmpfile=$tmpcore
        is_ok=$is_core_ok
        ;;
    sh)
        link=https://ghproxy.net/https://github.com/233boy/v2ray/releases/download/v4.23/code.zip
        name="$is_core_name 脚本"
        tmpfile=$tmpsh
        is_ok=$is_sh_ok
        ;;
    jq)
        link=https://ghproxy.net/https://github.com/jqlang/jq/releases/download/jq-1.7.1/jq-linux-$is_jq_arch
        name="jq"
        tmpfile=$tmpjq
        is_ok=$is_jq_ok
        ;;
...
pass_args() {
    while [[ $# -gt 0 ]]; do
        case $1 in
        online)
            err "如果想要安装旧版本, 请转到: https://ghproxy.net/https://github.com/233boy/v2ray/tree/old"
            ;;
        -f | --core-file)
            [[ -z $2 ]] && {
